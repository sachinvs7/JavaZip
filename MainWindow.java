...
public class MainWindow extends JFrame {
	...
	private void initUI(){
		...
		final JButton addFileButton = new JButton("Add a file(s) to the file list to be zipped.");
		...
		final JButton saveFileButton = new JButton("Find a location and set a name for the zip file to be created.");
		...
		/*
		 * Adds a file or files to the list of files for zip.
		 */
